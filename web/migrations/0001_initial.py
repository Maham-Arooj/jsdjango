# Generated by Django 3.2.3 on 2021-07-01 12:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Date_Time', models.DateTimeField(default=datetime.datetime(2021, 7, 1, 17, 17, 30, 314162))),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ...
                ('Email', models.EmailField(max_length=254)),
                ('Date_Time', models.DateTimeField(default=datetime.datetime(2021, 7, 1, 17, 17, 30, 313162))),
            ],
        ),
        migrations.CreateModel(
            name='Employee',
            fields=[
                ...
                ('Date_Time', models.DateTimeField(default=datetime.datetime(2021, 7, 1, 17, 17, 30, 302162))),
            ],
        ),
        migrations.CreateModel(
            name='images',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Date_Time', models.DateTimeField(default=datetime.datetime(2021, 7, 1, 17, 17, 30, 309162))),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Description', models.CharField(max_length=30)),
                ('Date_Time', models.DateTimeField(default=datetime.datetime(2021, 7, 1, 17, 17, 30, 307162))),
            ],
        ),
        migrations.CreateModel(
            name='productimg',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Date_Time', models.DateTimeField(default=datetime.datetime(2021, 7, 1, 17, 17, 30, 305162))),
                ('Employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.employee')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Date_Time', models.DateTimeField(default=datetime.datetime(2021, 7, 1, 17, 17, 30, 311162))),
                ('Employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.employee')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Email', models.EmailField(max_length=254)),
                ('Date_Time', models.DateTimeField(default=datetime.datetime(2021, 7, 1, 17, 17, 30, 312162))),
                ('Supplier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.supplier')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Date_Time', models.DateTimeField(default=datetime.datetime(2021, 7, 1, 17, 17, 30, 304162))),
                ('Employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.employee')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Description', models.CharField(max_length=30)),
                ('Date_Time', models.DateTimeField(default=datetime.datetime(2021, 7, 1, 17, 17, 30, 308162))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Date_Time', models.DateTimeField(default=datetime.datetime(2021, 7, 1, 17, 17, 30, 303162))),
                ('Employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.employee')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Date_Time', models.DateTimeField(default=datetime.datetime(2021, 7, 1, 17, 17, 30, 315162))),
                ('Employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.employee')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Date_Time', models.DateTimeField(default=datetime.datetime(2021, 7, 1, 17, 17, 30, 316162))),
                ('Employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.employee')),
                ('Product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.product')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Mobile_Number2', models.CharField(max_length=30)),
                ('Email', models.EmailField(max_length=254)),
                ('Date_Time', models.DateTimeField(default=datetime.datetime(2021, 7, 1, 17, 17, 30, 306162))),
                ('Employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.employee')),
            ],
        ),
        migrations.CreateModel(
